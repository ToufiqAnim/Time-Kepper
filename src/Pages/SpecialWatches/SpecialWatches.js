...
const SpecialWatches = () => {
  return (
    <div className="specialWatch" style={{ backgroundColor: "#f7f7f7" }}>
      <p className="text-center  pt-5 mb-1">Best Choices</p>
      <hr className=" mx-auto mt-0 " style={{ width: "100px" }} />
      <h1 className="text-center fw-bold">
        <strong className="" style={{ color: "#eec277" }}>
          SPECIAL{" "}
        </strong>
      ...
      <div>
        <Carousel variant="dark mt-5 pb-5" style={{ height: "475px" }}>
          <Carousel.Item className="carousel-item">
            <Card
              className="special-card border-0"
              style={{ width: "100%", backgroundColor: "#f7f7f7" }}
            >
              <Card.Img
                className="cardImg"
                variant="top"
                src="https://cdn.shopify.com/s/files/1/2784/4648/products/FusionGreen-Packshot_1140x1140.png?v=1626268166"
              />
          ...
          <Carousel.Item className="carousel-item">
            ...
            >
              <Card.Img
                className="cardImg"
                variant="top"
                src="https://cdn.shopify.com/s/files/1/2784/4648/products/TheMomentumRoseGoldWatchPackshot_1140x1140.png?v=1631550546"
              />
          ...
          <Carousel.Item className="carousel-item">
            ...
            >
              <Card.Img
                className="cardImg"
                variant="top"
                src="https://cdn.shopify.com/s/files/1/2784/4648/products/MilanGreenPackshot_1140x1140.png?v=1608221003"
              />
          ...
          <Carousel.Item className="carousel-item">
            ...
            >
              <Card.Img
                className="cardImg"
                variant="top"
                src="https://cdn.shopify.com/s/files/1/2784/4648/products/PragueDeluxeBlack-Packshot_1140x1140.png?v=1624385176"
              />
